...
wb = openpyxl.load_workbook("C://Users//jazz.ooi//Desktop//proj//Sharpinvest//report_20220808.xlsx")
...
for i in range(2, xl_rows + 1):
    ...
    company_202206 = corr_data.cell(row=i, column=5).value
    company_202205 = corr_data.cell(row=i, column=6).value
    company_202204 = corr_data.cell(row=i, column=7).value
...
for i in range(0, len(xl_filenames)):
    xl_dict[xl_filenames[i]] = {202204: xl_202204[i], 202205: xl_202205[i], 202206: xl_202206[i]}
